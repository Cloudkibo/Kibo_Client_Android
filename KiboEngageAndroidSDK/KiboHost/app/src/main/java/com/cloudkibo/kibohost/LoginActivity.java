...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameView = (EditText) findViewById(R.id.customer_name);
    ...
    private void attemptLogin() {
        ...
        String password = mMobileView.getText().toString();
        String customer_id = mCustomerIdView.getText().toString();
        ...
        if (TextUtils.isEmpty(password)) {
            mMobileView.setError(getString(R.string.error_empty_phone));
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, customer_id, name);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String mobile, String customer_id, String name) {
            mEmail = email;
            mMobile = mobile;
